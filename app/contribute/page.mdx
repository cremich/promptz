...
**Compatibility:**
- <ModalityBadge support="both" /> **Universal** (CLI + IDE): Steering, Prompts
- <ModalityBadge support="cli" /> **CLI Only**: Custom Agents  
- <ModalityBadge support="ide" /> **IDE Only**: Agent Hooks, Kiro Powers
